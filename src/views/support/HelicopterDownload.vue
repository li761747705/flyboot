...
export default {
  ...
  data() {
    return {
      ...
      docsData: {
        docs: [
          { name: '无人直升机系列_用户手册', version: 'V1.0.3', date: '2024-01', format: 'PDF', url: '#' },
          { name: '无人直升机系列_快速指南', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { name: '无人直升机系列_技术规格书', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { name: '无人直升机系列_安全手册', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { name: '无人直升机系列_维护手册', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { name: '无人直升机系列_产品清单', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' }
        ],
        firmware: [
          { name: '无人直升机系列_固件更新说明', version: 'V1.0.3.71', date: '2024-06', format: 'PDF', url: '#' },
          { name: '无人直升机系列_固件包_V1.0.3.71', version: 'V1.0.3.71', date: '2024-06', format: 'BIN', url: '#' },
          { name: '无人直升机系列_固件升级工具', version: 'V1.0.2', date: '2024-05', format: 'EXE', url: '#' },
          { name: '无人直升机系列_固件回退包_V1.0.2', version: 'V1.0.2', date: '2024-05', format: 'BIN', url: '#' },
          { name: '无人直升机系列_固件校验工具', version: 'V1.0.1', date: '2024-04', format: 'EXE', url: '#' }
        ]
      }
    }
  },
