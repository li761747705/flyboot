    ...
    <div class="download-container">
      <div class="page-header">
        ...
        <h2 class="download-detail-title">
          <i class="bi bi-fan"></i>
          {{ $t('support.downloadDetail.titles.helicopter') }}
        </h2>
...
export default {
  ...
  metaInfo() {
    return {
      title: this.$t('meta.support.downloads.helicopter.title'),
      meta: [
        { name: 'description', content: this.$t('meta.support.downloads.helicopter.description') },
        { name: 'keywords', content: this.$t('meta.support.downloads.helicopter.keywords') }
      ]
    }
  },
  data() {
    return {
      ...
      docsData: {
        docs: [
          { nameKey: 'support.downloadDetail.docNames.helicopterUserManual', version: 'V1.0.3', date: '2024-01', format: 'PDF', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterQuickGuide', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterTechSpecs', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterSafetyManual', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterMaintenanceManual', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterPackingList', version: 'V1.0', date: '2024-01', format: 'PDF', url: '#' }
        ],
        firmware: [
          { nameKey: 'support.downloadDetail.docNames.helicopterFirmwareNotes', version: 'V1.0.3.71', date: '2024-06', format: 'PDF', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterFirmwarePackage', version: 'V1.0.3.71', date: '2024-06', format: 'BIN', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterFirmwareUpgradeTool', version: 'V1.0.2', date: '2024-05', format: 'EXE', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterFirmwareRollbackPackage', version: 'V1.0.2', date: '2024-05', format: 'BIN', url: '#' },
          { nameKey: 'support.downloadDetail.docNames.helicopterFirmwareVerifyTool', version: 'V1.0.1', date: '2024-04', format: 'EXE', url: '#' }
        ]
      }
    }
  },
